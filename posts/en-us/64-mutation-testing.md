...
👉 The second test, testing exactly the `100` boundary, is what kills the mutant that swapped `>` for `>=` — remember the edge case tests we've discussed since post 33? Mutation testing forces you to write them
