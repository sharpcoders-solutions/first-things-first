...
Your API is functional, but right now it accepts **any request from anyone**. Time to close that door.
...
Here you'll learn to correctly release unmanaged resources, like database connections and open files.
