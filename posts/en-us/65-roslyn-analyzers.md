...
👉 Combined with Serilog (post 40), this analyzer ensures no one accidentally goes back to `Console.WriteLine` — the warning shows up right in the editor, before code review even happens
