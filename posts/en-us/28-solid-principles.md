...
👉 A new customer type becomes a **new class** implementing `IDiscount` — `DiscountCalculator` never needs to be touched again. This is `interface` and polymorphism (posts 21 and 22) working together with software design
