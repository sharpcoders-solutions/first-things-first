...
- Serverless na AWS e na Azure, com os mesmos fundamentos aplicados em nuvens diferentes  
...
👉 Lembra do EF Core (post 32)? Desde o EF Core 6, `DateOnly` e `TimeOnly` são mapeados nativamente para os tipos `date` e `time` do SQL Server — sem precisar de conversores customizados, e sem o desperdício de armazenar uma parte de data ou hora que nunca será usada
