...
- Uma trilha que percorreu de .NET Framework clássico (post 12) até Native AOT (post 72) e todo o ecossistema moderno de nuvem  
...
// 3. As dependências (NuGet, post 66) já têm suporte à nova versão?
```
...
Novidades de linguagem C#: acompanham o .NET, mas evoluem em seu 
             próprio ritmo (lembra dos records do post 30? 
