...
👉 Um atributo customizado nada mais é do que uma classe que herda de `Attribute` — o mesmo mecanismo por trás de `[Fact]` (post 30) e `[Authorize]` (post 34)
...
- Usar Reflection para contornar encapsulamento (acessar campos `private` de fora), quebrando os princípios de OOP do post 20  
