...
👉 O segundo teste, testando exatamente o limite `100`, é o que mata o mutante que trocou `>` por `>=` — lembra dos testes de borda que discutimos desde o post 33? Mutation testing força você a escrevê-los
