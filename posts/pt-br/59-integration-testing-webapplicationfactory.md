...
👉 `IClassFixture<FabricaTestes>` compartilha a mesma instância da aplicação entre todos os testes da classe, evitando o custo de subir a aplicação a cada teste — cada `[Fact]` continua isolado (post 30), mas a infraestrutura é reutilizada
