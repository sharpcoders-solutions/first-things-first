...
👉 Um novo tipo de cliente vira uma **nova classe** que implementa `IDesconto` — `CalculadoraDesconto` nunca precisa ser tocada de novo. Isso é `interface` e polimorfismo (posts 21 e 22) trabalhando junto com design de software
