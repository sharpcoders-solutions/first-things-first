...
👉 Combinado com o Serilog (post 40), esse analyzer garante que ninguém volte a usar `Console.WriteLine` sem querer — o aviso aparece direto no editor, antes mesmo do code review
