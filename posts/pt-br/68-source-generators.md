...
- Roslyn Analyzers para criar regras de análise customizadas (post 62)  
...
```csharp
// Com Reflection (post 67): lento, roda a cada chamada
...
👉 Isso lembra o Roslyn Analyzer do post 62 — mas em vez de só reportar um diagnóstico, o generator **adiciona arquivos de código C# novos** à compilação, antes mesmo do build terminar
...
- Subestimar a curva de aprendizado — Source Generators exigem entender a árvore sintática do Roslyn, como no post 62  
...
- A base técnica é a mesma dos Roslyn Analyzers do post 62, mas gerando código em vez de só diagnósticos  
