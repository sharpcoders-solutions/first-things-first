...
- Unsafe code e ponteiros (post 69), incluindo uma introdução rápida a P/Invoke  
...
Assim como as outras funcionalidades baseadas em source generator que você já viu, `[LibraryImport]` gera código de marshaling em tempo de **compilação**, em vez de usar reflection em runtime — mais rápido, e compatível com Native AOT (post 72), onde `[DllImport]` tradicional pode ter limitações
