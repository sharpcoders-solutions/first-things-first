...
👉 Diferente do Blazor WASM (post 82), que roda dentro de um navegador, o MAUI gera aplicativos verdadeiramente nativos — acesso total a câmera, GPS, notificações push, sensores
...
- Reutiliza componentes Blazor (post 82) dentro de um app MAUI  
